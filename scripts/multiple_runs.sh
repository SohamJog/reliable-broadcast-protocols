...
# run: ./scripts/test.sh testdata/hyb_4/syncer Hi false testdata/test_msgs.txt ecc_rbc
# wait 1 second
...
do
  ...
  ./scripts/test.sh testdata/hyb_4/syncer Hi false testdata/test_msgs.txt ecc_rbc
  sleep 1
